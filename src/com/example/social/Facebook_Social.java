...
public class Facebook_Social extends FragmentActivity {
    ...
    private final String PENDING_ACTION_BUNDLE_KEY = "kietlpt.fpoly.mob201_s3_loginfb:PendingAction";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_facebook_social);

        loginButton = (LoginButton) findViewById(R.id.login_button);
        loginButton.setUserInfoChangedCallback(new LoginButton.UserInfoChangedCallback() {
            @Override
            public void onUserInfoFetched(GraphUser user) {
            	Facebook_Social.this.user = user;
                updateUI();
    ...
    private void onSessionStateChange(Session session, SessionState state, Exception exception) {
        if (pendingAction != PendingAction.NONE &&
                ...
                new AlertDialog.Builder(Facebook_Social.this)
...
//                    .setPositiveButton(R.string.ok, null)
    ...
    private void showPublishResult(String message, GraphObject result, FacebookRequestError error) {
        ...
        if (error == null) {
            ...
            alertMessage = "successfully_posted_post" + message + id;
        } else {
            title = "error";
    ...
    private void postStatusUpdate() {
        if (canPresentShareDialog) {
            ...
            final String message = "status_update" + user.getFirstName() + (new Date().toString());
    ...
    private void showPickerFragment(PickerFragment<?> fragment) {
        fragment.setOnErrorListener(new PickerFragment.OnErrorListener() {
            ...
            public void onError(PickerFragment<?> pickerFragment, FacebookException error) {
                ...
                Toast toast = Toast.makeText(Facebook_Social.this, text, Toast.LENGTH_SHORT);
                toast.show();
            }
        });
